...
try {
  const modelId = await loadModel({
    modelSrc: TTS_SUPERTONIC_OFFICIAL_TEXT_ENCODER_SUPERTONE_FP32.src,
    modelType: "tts",
    modelConfig: {
      ...
      ttsTextEncoderSrc: TTS_SUPERTONIC_OFFICIAL_TEXT_ENCODER_SUPERTONE_FP32.src,
      ttsDurationPredictorSrc: TTS_SUPERTONIC_OFFICIAL_DURATION_PREDICTOR_SUPERTONE_FP32.src,
      ttsVectorEstimatorSrc: TTS_SUPERTONIC_OFFICIAL_VECTOR_ESTIMATOR_SUPERTONE_FP32.src,
      ttsVocoderSrc: TTS_SUPERTONIC_OFFICIAL_VOCODER_SUPERTONE_FP32.src,
      ttsUnicodeIndexerSrc: TTS_SUPERTONIC_OFFICIAL_UNICODE_INDEXER_SUPERTONE.src,
      ttsTtsConfigSrc: TTS_SUPERTONIC_OFFICIAL_TTS_CONFIG_SUPERTONE.src,
      ttsVoiceStyleSrc: TTS_SUPERTONIC_OFFICIAL_VOICE_STYLE_SUPERTONE.src,
    },
